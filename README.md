...
Somewhat minimized source code (2181 characters)
...
);ad=fmin(ad,sdvl(p-V(.9,-.3,.25),.15,.6));D td=fmin(dd,ad);D
pd=(p-V(0,.7,0)).dot(!V(0,-1,0));c=td<pd?V(.13,.54,.13):V(1,.38,.28);return
fmin(td,pd);}V march(V e,V rd,I l,I& h){V c;V l1=!V(0,-1,.3);for(I
i=0;i<100;++i){D d=sdf(e,c);if(d<eps){V cc;V
...
V(.3,.2,.6);}I main(){I w=512,h=w;I samples=10;V look_at(.4,0,0);V
